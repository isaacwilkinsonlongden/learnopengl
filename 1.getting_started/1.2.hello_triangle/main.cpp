...
int main() {
    ...
    // link shaders orange fragment shader
    ...
    // link shaders yellow fragment shader
    ...
    // you can unbind the VAO afterwards so other VAO calls won't accidentally modify this VAO, but this rarely happenes.
